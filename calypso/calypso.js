...
const ASSETS = {
    "USDC": { "mint": "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v", "decimals": 6, "allocation": new Decimal(process.env.USDC_ALLOCATION || '0.30') },
    "JTO": { "mint": "jtojtomepa8beP8AuQc6eXt5FriJwfFMwQx2v2f9mCL", "decimals": 9, "allocation": new Decimal(process.env.USDC_ALLOCATION || '0.0') },
    "WIF": { "mint": "EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLHYxdM65zcjm", "decimals": 6, "allocation": new Decimal(process.env.USDC_ALLOCATION || '0.0') },
    "SOL": { "mint": "So11111111111111111111111111111111111111112", "decimals": 9, "allocation": new Decimal(process.env.USDC_ALLOCATION || '0.30') },
    "JUP": { "mint": "JUPyiwrYJFskUPiHa7hkeR8VUtAeFoSYbKedZNsDvCN", "decimals": 6, "allocation": new Decimal(process.env.USDC_ALLOCATION || '0.10') },
    "JLP": {"mint": "27G8MtK7VtTcCHkpASjSDdkWWYfoqT6ggEuKidVJidD4", "decimals": 6, "allocation": new Decimal(process.env.USDC_ALLOCATION || '0.30') },
};
...
const KEYPAIR_PATH = process.env.KEYPAIR_PATH || "calypso.json";
...
const STASH_THRESHOLD = new Decimal(process.env.STASH_THRESHOLD || '42');
const STASH_AMOUNT = new Decimal(process.env.STASH_AMOUNT || '1');
const STASH_ADDRESS = new web3.PublicKey(process.env.STASH_ADDRESS || "StAshdD7TkoNrWqsrbPTwRjCdqaCfMgfVCwKpvaGhuC");
